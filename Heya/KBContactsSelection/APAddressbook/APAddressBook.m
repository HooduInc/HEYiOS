                 ...
                 completion:(void (^)(NSArray *contacts, NSError *error))completionBlock
{
    ...
    int statusType = [APAddressBook access];
    
    if (statusType == 0 || statusType == 2)
    {
        [self accessNotGrantedForAddressBook];
...
-(void)accessNotGrantedForAddressBook
{
    UIAlertView *statusAlert =[[UIAlertView alloc] initWithTitle:@"Privacy Warning!" message:@"Permission was not granted for contacts.\nTip: Go to settings->Hey and allow contatcs." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
