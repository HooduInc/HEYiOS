...
- (id)initWithRecordRef:(ABRecordRef)recordRef fieldMask:(APContactField)fieldMask
{
    ...
    if (self)
    {
        ...
        if (fieldMask & ABPersonHasImageData(recordRef))
        {
...
{
    APContact *copy = [[APContact allocWithZone: zone] init];
    
    [copy setFieldMask:_fieldMask];
    [copy setFirstName:_firstName];
    [copy setMiddleName:_middleName];
    [copy setLastName:_lastName];
    [copy setCompositeName:_compositeName];
    [copy setCompany:_company];
    [copy setPhones:_phones];
    [copy setPhonesWithLabels:_phonesWithLabels];
    [copy setEmails:_emails];
    [copy setAddresses:_addresses];
    [copy setPhoto:_photo];
    [copy setThumbnail:_thumbnail];
    [copy setRecordID:_recordID];
    [copy setCreationDate:_creationDate];
    [copy setModificationDate:_modificationDate];
    [copy setSocialProfiles:_socialProfiles];
    [copy setNote:_note];
