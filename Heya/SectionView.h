...
- (void) toggleButtonPressed : (BOOL) flag sender:sender;
...
@optional
- (void) sectionClosed : (NSInteger) section sender:(id) sender;
- (void) sectionOpened : (NSInteger) section sender:(id) sender;
