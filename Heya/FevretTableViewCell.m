...
@interface FevretTableViewCell()<UIGestureRecognizerDelegate>
...
@implementation FevretTableViewCell

@synthesize name_lbl,profileImg,favoriteId,favoriteOrder;

#pragma mark
#pragma mark - Cell Initilization
#pragma mark
...
- (void)setItemText:(NSString *)itemText
{
    ...
    self.nameLabelText.text = _itemText;
    self.name_lbl.text = _itemText;
}
