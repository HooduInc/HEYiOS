...
@interface GroupTableViewCell()<UIGestureRecognizerDelegate>
...
@synthesize groupIdString, groupOrderString;


- (void)awakeFromNib
{
    [super awakeFromNib];
    self.groupNameLabel.font = [UIFont fontWithName:@"OpenSans-Bold" size:15];
    ...
    [self.myConteView addGestureRecognizer:self.panRecognizer];
...
- (void)panThisCell:(UIPanGestureRecognizer *)recognizer {
    switch (recognizer.state) {
        case UIGestureRecognizerStateBegan:
            self.panStartPoint = [recognizer translationInView:self.myConteView];
        ...
        case UIGestureRecognizerStateEnded:
            ...
            {
                //Cell was closing
                CGFloat buttonOnePlusHalfOfButton2 = CGRectGetWidth(self.deleteTextBtn.frame) + (CGRectGetWidth(self.changeTextBtn.frame) / 2); //4
...
- (void)setItemText:(NSString *)itemText
{
    ...
    self.groupNameLabel.text = _itemText;
